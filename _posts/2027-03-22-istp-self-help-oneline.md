---
layout: post
title: "ISTP 자기계발서 한 줄 처방 - 평생 가는 자기계발서의 시작"
date: 2027-03-22 10:00:00 +0900
categories: [자기계발]
tags: ["MBTI", "자기계발서", "ISTP", "장인", "ISTP 자기계발서", "MBTI 자기계발서", "16유형", "성격별", "oneline"]
description: "ISTP에게 자기계발서는  ISTP는 자기계발서를 '실용적 도구를 얻을 자료'로 본다. 감정 호소나 도덕적 훈계에는 즉시 거리를 둔다. 메커니즘 분석과 실전 응용이 있는 책에 끌린다.     한 줄 처방    ISTP의 독서 원칙: 한 권에서 도구 하나만 손에 남..."
...
ISTP는 책을 통째로 읽기보다 필요한 부분만 골라 자기 작업에 적용하는 방식이 자연스럽다. 목차에서 가장 끌리는 챕터부터 시작하라. 1장부터 순서대로 읽을 의무는 없다.

ISTP는 책의 도구를 자기 분야에 적용해 실험하는 방식으로 가장 잘 흡수한다. 실험 결과를 한 줄씩 메모해 두면 자기만의 도구 모음이 만들어진다. 5년 뒤 그 메모가 책 자체보다 가치 있다.

## 다음 단계

ISTP에게 자기계발서 운영체계의 출발점은 **안티프래질 (나심 탈레브, 와이즈베리)** 입니다. ISTP에게 잘 맞는다. "충격을 어떻게 자기 강점으로 바꿀 것인가"를 다양한 실제 사례로 분석한다. ISTP의 분석가적 성향에 부합한다. 1부의 "취약성-강건성-안티프래질" 3분류는 ISTP가 자기 인생의 어떤 영역이 어떤 상태인지 점검하기에 좋은 도구다. 추상이 아...
