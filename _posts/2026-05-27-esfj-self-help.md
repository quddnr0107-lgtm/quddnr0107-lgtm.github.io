---
layout: post
title: "ESFJ 집정관에게 추천하는 자기계발서 책 5권 - MBTI 자기계발서 처방"
date: 2026-05-27 10:00:00 +0900
categories: [자기계발]
tags: ["MBTI", "자기계발서", "ESFJ", "집정관", "ESFJ 자기계발서", "MBTI 자기계발서", "16유형", "성격별"]
description: "ESFJ는 자기계발서를 '내 주변과 함께 잘 사는 법'으로 본다. 자신만 잘되는 메시지보다 '관계 안에서 더 잘 사는 법'을 다루는 책에 끌린다. 너무 개인주의적이거나 차가운 책은 거부감이 든다.  ESFJ 학부모 정 모 씨는 동네 엄마들 단톡방의 책 추천 정보를 늘 ..."
keywords: "MBTI 자기계발, 성격별 자기계발서, 16유형 책 추천, ESFJ 자기계발서, 집정관 자기계발서"
...
- "신경 끄기의 기술" (마크 맨슨) — "남 신경 끄라"가 ESFJ의 본성과 맞지 않는다. ESFJ는 사람을 챙기는 것이 자기 정체성의 핵심인데 이 책은 그것을 "비효율"로 규정한다. 한 줄만 가져간다면 "신경 쓸 대상을 줄여서 진짜 중요한 사람에게 집중하라"는 부분이다. 모든 사람을 똑같이 챙기다 정작 가족이 뒤로 밀리는 ESFJ의 패턴을 점검하는 데 쓸 수 있다.
- "부의 추월차선" (엠제이 드마코) — 사람보다 시스템 강조에 거리감을 느낀다. "빠른 부"라는 메시지가 ESFJ가 평생 지켜 온 "성실한 안정"의 가치와 충돌한다. 한 줄만 가져간다면 "시간과 돈이 1:1로 묶인 구조는 내가 멈추면 가족도 멈춘다"는 인식이다. 자녀 양육과 부모 부양이 동시에 걸려 있는 ESFJ에게 단일 수입 구조의 취약성은 점검해 둘 가치가 있다.
- "안티프래질" (나심 탈레브) — 학구적이고 비인격적 어조에 ESFJ가 피로감을 느낀다. 책 전체가 "숫자와 사례" 중심이라 사람 이야기를 좋아하는 ESFJ의 흡수 방식과 안 맞는다. 한 줄만 가져간다면 "한 곳에 모든 의존을 두면 그 한 곳이 무너질 때 전체가 무너진다"는 원칙이다. 가족 의존 구조에 대한 점검에 쓸 수 있다.
...
ESFJ의 가장 흔한 실수는 "남 챙기는 데만 적용하고 자기에게는 안 적용하는 것"이다. 책을 한 권 읽으면 "이걸 우선 나에게 적용한다"를 첫 줄에 적어라. 1년에 한 번은 의도적으로 "나만 챙기는 책"(자존감 수업, 신경 끄기의 기술의 부분 발췌)을 읽어 보라.
