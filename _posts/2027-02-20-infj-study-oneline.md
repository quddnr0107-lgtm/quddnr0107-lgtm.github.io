---
layout: post
title: "INFJ 공부법 한 줄 처방 - 평생 가는 공부법의 시작"
date: 2027-02-20 10:00:00 +0900
categories: [공부법]
tags: ["MBTI", "공부법", "INFJ", "옹호자", "INFJ 공부법", "MBTI 공부법", "16유형", "성격별", "oneline"]
description: "INFJ에게 공부법은  INFJ는 공부를 '점수를 위한 기계적 반복'이 아니라 '내가 어떤 사람이 되고 싶은가'라는 질문 안에 묶을 때 가장 오래 간다. 모의고사 등수표 한 줄로는 INFJ의 동기를 살릴 수 없다. '이 자격증으로 내가 누구를 도울 수 있는가',..."
...
INFJ의 학습 시간대는 늦은 오후·저녁이 맞다. 새벽 5시 기상은 INFJ의 신경계와 안 어울린다. 외부 자극이 가라앉는 시간에 INFJ의 사고가 가장 깊어진다. 학원 새벽반은 피하고 저녁반·인강 야간 시청 루틴을 구성하라.

학습 공간은 "빛이 따뜻하고 사람 시선이 적은 곳"이 좋다. 큰 학원 자습실의 형광등 벽보다 동네 작은 도서관·카페 한 자리·집의 한 코너가 INFJ의 지속력을 만든다. 매번 다른 자리는 INFJ에게 자극 과부하다.

## 다음 단계

INFJ에게 공부법 운영체계의 출발점은 **자기 페이스 인강 (완강 압박 없이)** 입니다. EBSi·메가스터디·이투스 인강을 "완강해야 한다"는 의무에서 분리해서 듣는 방식이 INFJ에게 맞는다. INFJ는 한 강의를 두 번, 세 번 깊이 듣고 자기 노트로 옮기는 학습에서 가장 강하다. "오늘 몇 강"이 아니라 "오늘 한 단원을 내 언어로 정리했는가"가 IN...
