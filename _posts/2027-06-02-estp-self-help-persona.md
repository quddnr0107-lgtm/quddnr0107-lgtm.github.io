---
layout: post
title: "30대 ESTP이 본 자기계발서 - 사례로 배우는 성향별 처방"
date: 2027-06-02 10:00:00 +0900
categories: [자기계발]
tags: ["MBTI", "자기계발서", "ESTP", "사업가", "ESTP 자기계발서", "MBTI 자기계발서", "16유형", "성격별", "persona"]
description: "ESTP 사업가의 사례  ESTP는 자기계발서를 '오늘 당장 써먹을 무기'로 본다. 이론과 사색을 길게 풀어내는 책은 못 견딘다. 행동 지향적이고 결과가 빠른 책에 끌린다.  ESTP의 독서 동기는 단순하다. '지금 돈이 되거나 지금 결과가 나오는가.' 위로나 마..."
...
ESTP의 독서 동기는 단순하다. "지금 돈이 되거나 지금 결과가 나오는가." 위로나 마음의 정돈은 ESTP의 독서 이유가 아니다. INFP가 "이 문장이 아름다워서" 산다면 ESTP는 "이 책에 30일 안에 결과 나는 방법이 있는가"로 산다.

## 무엇이 달랐는가

이 사례에서 가장 중요한 지점은 ESTP이 다른 유형과 다른 도파민·동기 메커니즘을 가졌다는 사실입니다. 같은 자기계발서 방식이 다른 유형에 효과적이어도 ESTP에는 안 통할 수 있습니다.

## ESTP이 시도해야 할 방향

부의 추월차선 (엠제이 드마코, 토트) — ESTP에게 가장 흥분되는 책이다. 빠른 행동과 시스템 구축을 강조해서 ESTP의 본성과 맞는다. 다만 모든 사람이 사업가가 되어야 한다는 식으로 받아들이지는 말 것. 저자의 "인도, 서행차선, 추월차선" 3분류는 ESTP가 자기 현재 위치를 단순하게 파악하는 데 좋은 프레임이다. 사례가 풍부하고 어조가 단호해서 ESTP...
