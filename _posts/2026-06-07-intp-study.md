---
layout: post
title: "INTP 논리술사에게 추천하는 공부법 방식 5가지 - MBTI 공부법 처방"
date: 2026-06-07 10:00:00 +0900
categories: [공부법]
tags: ["MBTI", "공부법", "INTP", "논리술사", "INTP 공부법", "MBTI 공부법", "16유형", "성격별"]
description: "30대 자격증 준비 박 모 씨(INTP)는 공부를 결심한 뒤 첫 한 달 동안 본 학습을 거의 하지 않았다. 대신 그가 한 일은 '인강 vs 책 단권화 vs 기출 회독 vs 백지 복습 vs Anki vs 코넬 노트'의 메타 분석이었다. 학습법 책 7권을 동시에 읽었고, ..."
keywords: "MBTI 공부법, 성격별 공부법, 16유형 공부법, INTP 공부법, 논리술사 공부법"
...
- 한 학습법 1년 고정 운영 — "이 방법이 정답이니 끝까지 간다"는 식의 단일 방법 고수는 INTP의 호기심을 고갈시킨다. 같은 단권화 책을 같은 방식으로 5회독 하면 INTP의 머리는 정보를 거부하기 시작한다. 적어도 30일 주기로 회독 방식·노트 도구·복습 시간대 중 하나를 로테이션하라.
- 매뉴얼 강제형 학원 정규반 — 진도·과제·시험이 외부에서 일률적으로 결정되는 학원 정규반은 INTP의 즉흥성과 정면 충돌한다. 학원 진도가 자기 호기심이 꽂힌 단원을 건너뛰면 INTP는 그날부로 학원을 끊는다. 차라리 인강 단과를 자기 페이스로 골라 듣거나 1:1 과외(질문 가능형)를 선택하라.
- 일타강사 추종 "이 강사만 들으면 된다" 식의 절대화 — INTP는 권위에 본능적 비판이 걸린다. 일타강사 강의를 듣더라도 "이 강사의 풀이가 나에게 왜 잘 들어오는가"의 메커니즘 질문을 던지지 않으면 학습이 표면에 머문다. 한 강사 + 보조 자료 1~2개를 조합해 자기 사고로 재구성하라.
...
INTP가 공부에서 가장 흔한 실수는 "한 개념 깊이 파다가 시험 범위를 못 끝내는 것"이다. 단원 한 곳에 호기심이 꽂히면 그 단원만 5회독을 하고 나머지 12단원을 못 본다. 시험 한 달 전에 "이 시험은 내 호기심에 안 맞아"라며 갈아타고, 새 학습법 책만 또 사 모은다.
