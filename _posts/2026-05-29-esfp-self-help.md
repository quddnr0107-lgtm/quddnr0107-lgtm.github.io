---
layout: post
title: "ESFP 연예인에게 추천하는 자기계발서 책 5권 - MBTI 자기계발서 처방"
date: 2026-05-29 10:00:00 +0900
categories: [자기계발]
tags: ["MBTI", "자기계발서", "ESFP", "연예인", "ESFP 자기계발서", "MBTI 자기계발서", "16유형", "성격별"]
description: "ESFP는 자기계발서를 '인생을 더 즐겁게 만들 영감'으로 본다. 단조롭고 무거운 책은 못 견딘다. 사람 이야기, 사례 중심, 가볍게 읽히는 책에 끌린다.  ESFP는 책에서 영감을 받으면 즉시 주변 사람에게 공유한다. 그게 ESFP의 학습 방식이다. 다만 그 영감이 ..."
...
- "딥 워크" (칼 뉴포트, 민음사) — 알림을 끊고 혼자 4시간 집중하라는 메시지가 ESFP의 사교성과 정면 충돌한다. 책장을 펴기만 해도 답답함이 든다. 그래도 "하루 한 번 집중 시간 블록"이라는 가벼운 도구 하나는 산만한 ESFP에게 결정적 한 시간을 선물한다.
- "에센셜리즘" (그렉 맥커운, 알에이치코리아) — 선택을 좁히고 거절하라는 메시지가 "많은 사람, 많은 기회"를 좋아하는 ESFP와 충돌한다. 인생이 좁아지는 느낌이 든다. 그래도 "매주 모든 약속에 "예"라고 하지 않기" 한 가지 룰은 ESFP가 번아웃을 피하는 데 결정적이다.
- "12가지 인생의 법칙" (조던 피터슨, 메이븐) — 무겁고 길고 사색적이라 한 챕터를 끝내기 어렵다. 어조가 무거워서 ESFP의 밝은 결과 안 맞는다. 그래도 "방을 청소하라" 같은 가장 단순한 법칙 하나는 ESFP가 "바깥 즐거움 전에 자기 환경부터 정리"하는 출발점이 된다.
...
ESFP의 가장 흔한 실수는 "읽고 나서 며칠 안에 잊는 것"이다. 책 한 권당 "이번 주 사람들과 만났을 때 한 가지 시도"만 정하라. 그 시도를 친구에게 미리 알리면 ESFP는 잊지 않는다. 사회적 약속이 ESFP에게는 가장 강한 동기다.
...
<a href="https://www.coupang.com/np/search?q=%EC%96%B4%EB%96%BB%EA%B2%8C%20%EC%9B%90%ED%95%98%EB%8A%94%20%EA%B2%83%EC%9D%84%20%EC%96%BB%EB%8A%94%EA%B0%80&channel=user&lptag=AF2582293&subId=mbti_book" target="_blank" rel="nofollow sponsored noopener" class="coupang-btn">
  <span class="coupang-tag">쿠팡</span>
  <span class="coupang-title">어떻게 원하는 것을 얻는가</span>
  <span class="coupang-arrow">최저가 보기 →</span>
</a>
