...
categories: [자기계발]
tags: ["MBTI", "자기계발서", "ISFJ", "수호자", "ISFJ 자기계발서", "MBTI 자기계발서", "16유형", "성격별", "recommend"]
description: "ISFJ 수호자의 자기계발서 성향  ISFJ는 자기계발서를 '내 일상과 관계를 더 잘 돌보는 가이드'로 본다. 위험을 감수하고 큰 변화를 시도하라는 책보다 '지금 자리에서 더 잘 사는 법'을 다루는 책에 끌린다.  ISFJ 간호사 박 모 씨는 야간 근무를 마치고..."
