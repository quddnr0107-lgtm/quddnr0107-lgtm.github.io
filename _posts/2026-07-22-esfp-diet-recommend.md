...
categories: [다이어트]
tags: ["MBTI", "다이어트", "ESFP", "연예인", "ESFP 다이어트", "MBTI 다이어트", "16유형", "성격별", "recommend"]
description: "ESFP 연예인의 다이어트 성향  ESFP는 다이어트를 '내 일상을 더 신나게 만드는 프로젝트'로 본다. 혼자 골방에서 닭가슴살 씹는 다이어트는 ESFP에게 형벌이다. 사람들과 함께, 음악과 함께, SNS 인증과 함께 가는 다이어트만 ESFP에게 지속된다.  ES..."
