---
layout: post
title: "ESTP 사업가에게 추천하는 공부법 방식 5가지 - MBTI 공부법 처방"
date: 2026-06-14 10:00:00 +0900
categories: [공부법]
tags: ["MBTI", "공부법", "ESTP", "사업가", "ESTP 공부법", "MBTI 공부법", "16유형", "성격별"]
description: "ESTP는 공부를 '단기 챌린지'로 본다. 1년 자기주도학습, 200시간 인강 패스, 두꺼운 단권화 노트 — 이 모든 '길고 정적인 것'에 ESTP는 약하다. 대신 4주 챌린지, 모의고사 점수 시각화, 즉시 채점되는 게임화 학습에는 강하다.  20대 자격증 준비를 한 ..."
keywords: "MBTI 공부법, 성격별 공부법, 16유형 공부법, ESTP 공부법, 사업가 공부법"
...
- 단권화 노트 1년 정리 — 두꺼운 노트 한 권에 1년 동안 모든 개념을 색깔별로 정리하는 방식은 ESTP에게 즉시성이 없다. 정리하는 동안 점수가 안 움직인다는 감각이 ESTP의 의욕을 죽인다.
- 인강 200시간 패스 — "이거 다 들어야 시작"이라는 구조 자체가 ESTP의 행동 본능과 부딪힌다. 200시간 중 50시간도 못 보고 그만둘 확률이 가장 높은 유형이다. 차라리 단과 30시간 + 기출 풀이가 ESTP에게 맞다.
- 명상형 학습·마인드풀 공부법 — "한 문장씩 음미하라", "호흡에 집중하라" 같은 접근은 ESTP에게 비효율로 느껴진다. 빨리 풀고 빨리 채점하는 사이클이 ESTP의 본성이다.
...
ESTP의 가장 큰 실패 패턴은 "문제 풀이만 가다 어느 단계에서 점수가 안 오르는 것"이다. 기출 회독은 빠르지만 응용 문제, 신유형 문제에서 막힌다. 개념이 빠졌기 때문이다. 매주 한 번, 일요일 1~2시간만 그 주에 자주 틀린 단원의 개념 강의를 보거나 교과서를 읽어라. 짧고 강한 개념 점검이 ESTP의 점수 정체기를 뚫는 유일한 방법이다.
