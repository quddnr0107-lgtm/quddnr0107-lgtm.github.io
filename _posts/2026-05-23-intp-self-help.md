---
layout: post
title: "INTP 논리술사에게 추천하는 자기계발서 책 5권 - MBTI 자기계발서 처방"
date: 2026-05-23 10:00:00 +0900
categories: [자기계발]
tags: ["MBTI", "자기계발서", "INTP", "논리술사", "INTP 자기계발서", "MBTI 자기계발서", "16유형", "성격별"]
description: "20대 후반 대학원생 이 모 씨(INTP)는 도서관에서 자기계발서 코너에 가면 매번 같은 행동을 한다. 한 권을 펼치고 30분간 서서 읽는다. 흥미로운 챕터를 만나면 책을 사 와 집에서 또 한 시간을 읽는다. 그러나 그 책을 다 읽는 일은 거의 없다. 책장에는 '3분의..."
...
- "부자 아빠 가난한 아빠" (로버트 기요사키) — 과도하게 단순한 이분법 모델에 INTP의 비판 의식이 발동한다. "자산과 부채의 정의"부터 INTP에게는 거칠게 느껴진다. "이게 다인가"라는 의문이 책을 덮게 만든다. 만약 읽는다면 "이 책의 단순화가 어디서 멈추는가"를 표시하며 읽어라. 비판적 주석을 다는 독서법이 INTP에게는 가장 자연스럽다.
- "성공하는 사람들의 7가지 습관" (스티븐 코비) — 매뉴얼화된 체계가 INTP의 즉흥적 사고와 답답하게 충돌한다. 7가지를 순서대로 따라야 한다는 구조 자체가 INTP에게는 갑갑하다. 만약 읽는다면 7가지 중 자신에게 가장 흥미로운 한 가지(예: "끝을 생각하며 시작하라")만 골라 깊이 파라. 나머지 6개는 무시해도 좋다.
- "역행자" (자청) — 단정적이고 강한 어조에 INTP의 회의주의가 발동한다. "이렇게 안 하면 평생 가난하다"는 식의 단정에 INTP는 자동으로 반문을 던진다. 책의 핵심 아이디어 한두 개는 가치 있지만 INTP는 그 아이디어에 도달하기 전에 어조에 거리감을 느낀다. 만약 읽는다면 어조는 무시하고 "이 저자가 무엇을 실제로 했는가"의 사실관계만 추출하라.
...
INTP가 자기계발서를 읽을 때 가장 흔히 빠지는 함정은 "이론으로만 남기는 것"이다. 통찰은 풍부하지만 적용은 없다. INTP에게는 "이 책에서 한 가지 행동만 시도한다"는 원칙이 필요하다. 가장 작은 행동부터, 일주일 안에 시작해야 한다.
...
<a href="https://www.coupang.com/np/search?q=%ED%81%B4%EB%A3%A8%EC%A7%80&channel=user&lptag=AF2582293&subId=mbti_book" target="_blank" rel="nofollow sponsored noopener" class="coupang-btn">
  <span class="coupang-tag">쿠팡</span>
  <span class="coupang-title">클루지</span>
  <span class="coupang-arrow">최저가 보기 →</span>
</a>
<a href="https://www.coupang.com/np/search?q=12%EA%B0%80%EC%A7%80%20%EC%9D%B8%EC%83%9D%EC%9D%98%20%EB%B2%95%EC%B9%99&channel=user&lptag=AF2582293&subId=mbti_book" target="_blank" rel="nofollow sponsored noopener" class="coupang-btn">
  <span class="coupang-tag">쿠팡</span>
  <span class="coupang-title">12가지 인생의 법칙</span>
  <span class="coupang-arrow">최저가 보기 →</span>
</a>
<a href="https://www.coupang.com/np/search?q=%EC%9D%B8%EC%8A%A4%ED%83%80%EB%B8%8C%EB%A0%88%EC%9D%B8&channel=user&lptag=AF2582293&subId=mbti_book" target="_blank" rel="nofollow sponsored noopener" class="coupang-btn">
  <span class="coupang-tag">쿠팡</span>
  <span class="coupang-title">인스타브레인</span>
  <span class="coupang-arrow">최저가 보기 →</span>
</a>
<a href="https://www.coupang.com/np/search?q=%ED%96%89%EC%9A%B4%EC%97%90%20%EC%86%8D%EC%A7%80%EB%A7%88%EB%9D%BC&channel=user&lptag=AF2582293&subId=mbti_book" target="_blank" rel="nofollow sponsored noopener" class="coupang-btn">
  <span class="coupang-tag">쿠팡</span>
  <span class="coupang-title">행운에 속지마라</span>
  <span class="coupang-arrow">최저가 보기 →</span>
</a>
