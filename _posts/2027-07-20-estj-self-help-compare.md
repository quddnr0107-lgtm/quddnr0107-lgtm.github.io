---
layout: post
title: "ESTJ vs INFP 자기계발서 차이 - 같은 자기계발서 다른 결과"
date: 2027-07-20 10:00:00 +0900
categories: [자기계발]
tags: ["MBTI", "자기계발서", "ESTJ", "경영자", "ESTJ 자기계발서", "MBTI 자기계발서", "16유형", "성격별", "compare"]
description: "ESTJ와 INFP는 자기계발서에서 정반대  같은 자기계발서 방식이 ESTJ에게는 약이 되고 INFP에게는 독이 됩니다. 또는 그 반대입니다.     ESTJ 경영자의 성향  ESTJ는 자기계발서를 '결과를 빨리 내는 도구'로 본다. 추상적이거나 감정적 책에 시간..."
...
variant: "compare"
---
## ESTJ와 INFP는 자기계발서에서 정반대

같은 자기계발서 방식이 ESTJ에게는 약이 되고 INFP에게는 독이 됩니다. 또는 그 반대입니다.
...
INFP는 ESTJ과 정보 처리·결정 방식이 다른 유형입니다. 자기계발서에서도 흥미·동기·실패 패턴이 완전히 다릅니다. 자세한 비교 표는 단행본 2부 5장 "같은 책, 네 가지 다른 반응"에서 다룹니다.
