---
layout: post
title: "ESTP vs INFJ 자기계발서 차이 - 같은 자기계발서 다른 결과"
date: 2027-08-05 10:00:00 +0900
categories: [자기계발]
tags: ["MBTI", "자기계발서", "ESTP", "사업가", "ESTP 자기계발서", "MBTI 자기계발서", "16유형", "성격별", "compare"]
description: "ESTP와 INFJ는 자기계발서에서 정반대  같은 자기계발서 방식이 ESTP에게는 약이 되고 INFJ에게는 독이 됩니다. 또는 그 반대입니다.     ESTP 사업가의 성향  ESTP는 자기계발서를 '오늘 당장 써먹을 무기'로 본다. 이론과 사색을 길게 풀어내는..."
...
variant: "compare"
---
## ESTP와 INFJ는 자기계발서에서 정반대

같은 자기계발서 방식이 ESTP에게는 약이 되고 INFJ에게는 독이 됩니다. 또는 그 반대입니다.
...
ESTP에게 가장 흥분되는 책이다. 빠른 행동과 시스템 구축을 강조해서 ESTP의 본성과 맞는다. 다만 모든 사람이 사업가가 되어야 한다는 식으로 받아들이지는 말 것. 저자의 "인도, 서행차선, 추월차선" 3분류는 ESTP가 자기 현재 위치를 단순하게 파악하는 데 좋은 프레임이다. 사례가 풍부하고 어조가 단호해서 ESTP가 끝까지 읽을 가능성이 높은 드문 ...

## INFJ와 어떻게 다른가

INFJ는 ESTP과 정보 처리·결정 방식이 다른 유형입니다. 자기계발서에서도 흥미·동기·실패 패턴이 완전히 다릅니다. 자세한 비교 표는 단행본 2부 5장 "같은 책, 네 가지 다른 반응"에서 다룹니다.
