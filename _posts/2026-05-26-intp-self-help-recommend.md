...
categories: [자기계발]
tags: ["MBTI", "자기계발서", "INTP", "논리술사", "INTP 자기계발서", "MBTI 자기계발서", "16유형", "성격별", "recommend"]
description: "INTP 논리술사의 자기계발서 성향  20대 후반 대학원생 이 모 씨(INTP)는 도서관에서 자기계발서 코너에 가면 매번 같은 행동을 한다. 한 권을 펼치고 30분간 서서 읽는다. 흥미로운 챕터를 만나면 책을 사 와 집에서 또 한 시간을 읽는다. 그러나 그 책을..."
